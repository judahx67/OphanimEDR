...
function ScoreBar({ value, label }: { value: number | null; label: string }) {
    ...
    return (
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <span style={{ fontFamily: 'var(--font-ui)', fontSize: 11, fontWeight: 600, color: SEV_COLOR(pct), minWidth: 30 }}>
                {pct}%
            </span>
...
export default function MLFindings() {
                                                ...
                                                <div key={i} style={{
                                                    ...
                                                    {e.ml_score_honest !== null && (
                                                        <span style={{
                                                            ...
                                                            color: SEV_COLOR(Math.round((e.ml_score_honest || 0) * 100)),
                                                            minWidth: 28, textAlign: 'right',
                                                        }}>
                                                            {Math.round((e.ml_score_honest || 0) * 100)}%
                                                        </span>
                                                    )}
